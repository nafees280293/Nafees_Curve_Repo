...
server = 'curves-prod.ckuiwkygw88o.us-east-1.rds.amazonaws.com'
objCDC=s3.get_object(Bucket='curves-prodenv', Key='CostRevenue_config.txt')
...
objC=s3.get_object(Bucket='curves-prodenv', Key='config.txt')
...
@dag(
    dag_id="Gorilla_Ercot_load_data_CSV_Generation_Hist",
    ...
    def insertData():
        ...
        for x in range(6):
            ...
            with io.StringIO() as csv_buffer:
                ...
                response = s3.put_object(Bucket='curves-prodenv', Key='Gorilla/'+csvName+str(int(x+1))+'.csv', Body=csv_buffer.getvalue())

...
filepath=Path('/Archive/MP2_SITE_LEVEL_FORECAST_MONTHLY_02-25-2024.csv')
#filepath='/intel_data/ShellCurveFiles/EOD Price Curves/Gas_05232023.csv'
...
key='Forecast_Data/MP2_SITE_LEVEL_FORECAST_MONTHLY_02-25-2024.csv'
...
def curve_etl_Operations_ForeCast():
        ...
        def file_read_from_drive_and_transform():
            ...
            if filepath.exists():
                ...
                processeddf.to_csv(f'/tmp/MP2_SITE_LEVEL_FORECAST_MONTHLY_02-25-2024.csv',index=False)
                logger.info("Write temp location was successful")
                return {
                          "filepath":f'/tmp/MP2_SITE_LEVEL_FORECAST_MONTHLY_02-25-2024.csv'
                                    }
            else:
...
etl_dag=curve_etl_Operations_ForeCast()

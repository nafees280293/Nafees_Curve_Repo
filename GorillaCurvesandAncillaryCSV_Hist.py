...
@dag(
    dag_id="Gorilla_Curves_and_Ancillary_CSV_Generation_Hist",
...
def callInsertData():
    ...
    def insertData():
        ...
        for x in groupData:
            ...
            query = f"exec sp_Curves_and_Ancillary_Hist '"+x.strip()+"'"
            ...
            with io.StringIO() as csv_buffer:
                ...
                response = s3.put_object(Bucket='curves-devenv', Key='Gorilla/'+x.strip()+'.csv', Body=csv_buffer.getvalue())

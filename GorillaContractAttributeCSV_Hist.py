...
@dag(
    dag_id="Gorilla_Contract_Attribute_CSV_Generation_Hist",
...
def callInsertData():
    ...
    def insertData():
        ...
        for x in groupData:
            ...
            query = f"exec sp_ContractAttribute '"+x.strip()+"'"
            ...
            with io.StringIO() as csv_buffer:
                ...
                response = s3.put_object(Bucket='curves-prodenv', Key='Gorilla/'+x.strip()+'.csv', Body=csv_buffer.getvalue())
